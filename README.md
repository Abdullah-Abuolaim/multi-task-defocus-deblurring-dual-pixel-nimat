...
```
## Our New Image Motion Attraction (NIMAT) Effect
...
## References
[1] Ali Karaali and Claudio Rosito Jung. *Edge-based defocus blur estimation with adaptive scale selection.* In TIP, 27(3):1126–1137, 2018.
<br>
[2] Junyong Lee, Sungkil Lee, Sunghyun Cho, and Seungyong Lee. *Deep defocus map estimation using domain adaptation.* In CVPR, 2019.